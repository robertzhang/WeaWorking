...
public class PullUpAndDownRefreshListView extends ListView implements OnScrollListener{
    ...
    //加载种类
    public final static int LOAD_NEW = 2;
    ...
    public PullUpAndDownRefreshListView(Context context) {  
        super(context);  
        init(context);  
    }  
  
    public PullUpAndDownRefreshListView(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init(context);  
    }  
    ...
    private void init(Context context) {  
        ...
        tv_bottom.setLayoutParams(lp);
        tv_bottom.setGravity(Gravity.CENTER);
        tv_bottom.setBackgroundColor(context.getResources().getColor(android.R.color.black));
        tv_bottom.setText("加载更多...");
        tv_bottom.setTextSize(20);
        tv_bottom.setTextColor(context.getResources().getColor(android.R.color.white));
        tv_bottom.setVisibility(View.GONE);
        addFooterView(tv_bottom, null, false);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {  
    	if (lastitem == getAdapter().getCount() && scrollState == OnScrollListener.SCROLL_STATE_IDLE && !isloadmore) {
    		isloadmore = true;
    		tv_bottom.setVisibility(View.VISIBLE);
    		onLvRefresh(LOAD_MORE);// 加载更多数据
    	}
    }  
    ...
    public void onRefreshComplete(int loadtype) {  // 根据加载类型做操作
    ...
    private void onLvRefresh(int loadtype) {  
        if (refreshListener != null) {  
            refreshListener.onRefresh(loadtype);  
        }  
    }  
